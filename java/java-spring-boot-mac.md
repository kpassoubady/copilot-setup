...
```bash
mkdir -p copilot-companion/projects/expense-tracker/java-spring-boot
...
mvn archetype:generate \
  ...
  -DartifactId=expense-tracker-app \
...
Create the main Spring Boot application class. Create the file `src/main/java/com/expensetracker/app/ExpenseTrackerApplication.java`:
...
```bash
mkdir -p src/main/java/com/expensetracker/app/config
```
...
Create a simple home controller. Create the file `src/main/java/com/expensetracker/app/controller/HomeController.java`:

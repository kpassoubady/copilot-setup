...
<img src="https://cdn.jsdelivr.net/gh/kpassoubady/marp-themes@main/logo.svg" alt="Kavin School" style="float: right; margin-left: 10px; width:100px" />
...
Tracks: Java (Spring Boot), Python (FastAPI), .NET (ASP.NET Core), or Python Data Analysis (Pandas), all following the same 2-session flow
...
- Three web tracks share the same Personal Expense Tracker starter codebase, set up via the installation guide:
...
- One data track uses a separate project, also set up via the installation guide:
  - Python Data Analysis Track: Data Analysis Pipeline (Pandas, Matplotlib, Seaborn) — uses `capstone-2-data-analysis/` from the companion repo instead of the Personal Expense Tracker
...
This table is the source of truth for session timing. The detailed walkthroughs below follow this same sequence without repeating durations.
...
| Bio Break | 10 min |
| Kahoot 1 (Welcome → Context Mastery) | 10 min |
| Showcase: [`github-copilot-helper`](https://github.com/kpassoubady/github-copilot-helper) | 30 min |
| Efficiency & Governance for Teams | 20 min |
| Bio Break | 10 min |
| Day 1 Wrap-up & Day 2 Preview | 10 min |
| Kahoot 2 (remaining content only) | 10 min |
| **Total** | **240 min** |
...
| Bio Break | 10 min |
| Kahoot 1 (Kickoff → Agents/MCP) | 10 min |
| Showcase: [`agent-hub`](https://github.com/kpassoubady/agent-hub) | 30 min |
...
### 1. Welcome & Intermediate Baseline Check
...
### 2. Advanced Copilot Interface & Productivity Recap
...
### 3. Breakout 1, Part A: Backend Modeling with Copilot
...
- Student Showcase: 2 to 3 minutes for a selected student demo

### Bio Break

### 4. Copilot Chat & Context Mastery (Intermediate)
...
### 5. Breakout 1, Part B: Backend Modeling with Copilot
...
### Kahoot 1
- Covers Welcome, Advanced Interface & Productivity Recap, Breakout 1 Part A, and Copilot Chat & Context Mastery (Intermediate) — everything delivered up to Context Mastery.

### 6. [`github-copilot-helper`](https://github.com/kpassoubady/github-copilot-helper) Showcase: Reusable Instructions, Prompts, Agents & Skills
...
### 7. Efficiency & Governance for Teams
...
### Kahoot 2
- Remaining-content-only: covers Breakout 1 Part B, the `github-copilot-helper` showcase, Efficiency & Governance, and the Day 1 Wrap-up. Does not repeat Kahoot 1's topics.
...
### 2. Advanced Chat Features: Terminal Context & Multi-File Editing
...
### 3. Breakout 2, Part A: Web Layer & APIs
...
### 4. Copilot Agents, Tool Sets & MCP Integrations
...
### 5. Breakout 2, Part B: Web Layer & APIs
...
### Kahoot 1
- Covers Day 2 Kickoff/Day 1 Recap, Advanced Chat Features, Breakout 2 Part A, and Copilot Agents, Tool Sets & MCP Integrations — everything delivered up to Agents/Tool Sets/MCP.

### 6. [`agent-hub`](https://github.com/kpassoubady/agent-hub) Showcase: Multi-Agent Factory Chain & Loop Framework
...
### 7. Troubleshooting, Rollback & Enterprise Governance
...
### 8. Course Wrap-up: Your Personal/Team Copilot Workflow Blueprint
...
### Kahoot 2
- Remaining-content-only: covers Breakout 2 Part B, the `agent-hub` showcase, Troubleshooting/Rollback/Governance, and the Course Wrap-up. Does not repeat Kahoot 1's topics.
